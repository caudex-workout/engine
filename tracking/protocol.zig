...
pub const RecommendationProvenance = struct {
    ...
    athleteProfileId: ?[]const u8 = null,
    athleteProfileRevision: ?u64 = null,
    athleteProfileFingerprint: ?[]const u8 = null,
    trainingLocationId: ?[]const u8 = null,
    effectiveEquipmentIds: []const []const u8 = &.{},
    availableMinutes: ?u16 = null,
    hardMaximumMinutes: ?u16 = null,
    sessionGoalId: ?[]const u8 = null,
    activeRestrictionIds: []const []const u8 = &.{},
};
...
fn provenanceFromDomain(value: ?tracking.Provenance) ?Provenance {
    ...
    return switch (provenance) {
        .recommendation => |item| .{ .recommendation = .{
            ...
            .athleteProfileId = item.athlete_profile_id,
            .athleteProfileRevision = item.athlete_profile_revision,
            .athleteProfileFingerprint = item.athlete_profile_fingerprint,
            .trainingLocationId = item.training_location_id,
            .effectiveEquipmentIds = item.effective_equipment_ids,
            .availableMinutes = item.available_minutes,
            .hardMaximumMinutes = item.hard_maximum_minutes,
            .sessionGoalId = item.session_goal_id,
            .activeRestrictionIds = item.active_restriction_ids,
        } },
...
fn provenanceToDomain(value: ?Provenance) tracking.Id.ParseError!?tracking.Provenance {
    ...
    return switch (provenance) {
        .recommendation => |item| .{ .recommendation = .{
            ...
            .athlete_profile_id = item.athleteProfileId,
            .athlete_profile_revision = item.athleteProfileRevision,
            .athlete_profile_fingerprint = item.athleteProfileFingerprint,
            .training_location_id = item.trainingLocationId,
            .effective_equipment_ids = item.effectiveEquipmentIds,
            .available_minutes = item.availableMinutes,
            .hard_maximum_minutes = item.hardMaximumMinutes,
            .session_goal_id = item.sessionGoalId,
            .active_restriction_ids = item.activeRestrictionIds,
        } },
