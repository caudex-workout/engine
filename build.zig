...
pub fn build(b: *std.Build) void {
    ...
    cli_database_json.expectStdOutEqual(
        "{\"schemaVersion\":1,\"kind\":\"caudex.database.info\",\"data\":{" ++
            ...
            "\"adapterVersion\":\"0.1.0\",\"databaseSchemaVersion\":7," ++
            "\"minimumSchemaVersion\":1,\"latestSchemaVersion\":7," ++
            "\"compatibility\":\"current\"}}\n",
    );
    ...
    cli_after_broken_pipe.expectStdOutEqual(
        "{\"schemaVersion\":1,\"kind\":\"caudex.database.info\",\"data\":{" ++
            ...
            "\"databaseSchemaVersion\":7,\"minimumSchemaVersion\":1," ++
            "\"latestSchemaVersion\":7,\"compatibility\":\"current\"}}\n",
    );
