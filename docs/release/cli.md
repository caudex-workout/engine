...
targets are x86_64/aarch64 Linux GNU, Apple Silicon macOS, and x86_64 Windows
GNU. Prebuilt macOS releases target Apple Silicon. Intel Macs can build Caudex
from source. Archives contain the CLI, README, LICENSE, NOTICE, and build metadata;
