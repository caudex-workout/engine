...
if (fingerprint !== "bc747f833ab3e31e2cad8e45ade4d42c12dfd73fbba86192a4dd87f201cbda3c") throw new Error("catalog fingerprint mismatch");
if (version !== "b0eed061e1c832b3ed815fbaa4b45b3cdc14df49" || catalog.mediaIncluded !== false) throw new Error("catalog provenance or media policy mismatch");
...
if (record.equipment?.id !== "free-exercise-db.equipment:dumbbell" || !record.primaryMuscles.every((muscle) => muscle.id.startsWith("free-exercise-db.muscle:"))) throw new Error("catalog taxonomy mapping failed");
